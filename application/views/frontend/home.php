...
<header>
   <!-- Full Page Intro -->
   <div class="view darken-4 justify-content-center" style="background-image: url('https://mdbootstrap.com/img/Photos/Others/images/89.jpg');">
      ...
      <div class="mask rgba-gradient d-flex justify-content-center align-items-center">
         ...
         <div class="container h-100">
            ...
            <div class="row align-items-center h-100">            
               <!--Grid column-->
               <div class="col-md-4 offset-md-4 text-center wow fadeInRight" data-wow-delay="0.2s">
                  <img src="<?= base_url('assets/img/slider-image.png'); ?>" alt="" class="img-fluid">
               </div>
               <!--Grid column-->
            </div>
            <!--Grid row-->
...
<div class="container my-5 py-5 z-depth-1">
  <!--Section: Content-->
  <section class="px-md-5 mx-md-5 text-center text-lg-left dark-text">
    <!--Grid row-->
    <div class="row">
      <!--Grid column-->
      <div class="col-md-6 mb-4 mb-md-0">
        <h3 class="font-weight-bold">Material Design Blocks</h3>
        <p class="text-justify">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Id quam sapiente molestiae
          numquam quas, voluptates omnis nulla ea odio quia similique corrupti magnam, doloremque laborum. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi dolorem pariatur a dignissimos porro sequi odit officiis repellendus rem commodi veritatis cupiditate quas nisi accusamus quisquam, hic enim nesciunt? Dignissimos.</p>
        <a class="btn btn-dark btn-md ml-0" href="#" role="button">Start now<i class="fa fa-gem ml-2"></i></a>
      </div>
      <!--Grid column-->
      <div class="col-md-6 mb-4 mb-md-0">
        <!--Image-->
...
<div class="container pt-3 mt-4">
   <div class="row text-center">
      <div class="col-md-10 offset-md-1">
         <h2 class="font-weight-bold display-4">Revolutionary Tattoo Experience</h2>
         <p class="font-weight-lighter">Our plant-based temporary tattoos are easily applied in few minutes, last 1-2 weeks, but look & feel like the real deal! Express delivery to your doorstep.</p>
      </div>
   </div>
</div>
<div class="container mt-5">
  ...
  <section class="dark-grey-text text-center">
    <!-- Section heading -->
    <h3 class="font-weight-bold mb-4 pb-2 text-uppercase">pick an option</h3>
  	<!-- Grid row -->
        ...
        <div class="card collection-card z-depth-1-half">
          ...
          <div class="view zoom">
            ...
            <div class="stripe dark">
              <a>
                <p class="text-uppercase font-weight-bold">xpress tattos
        ...
        <div class="card collection-card z-depth-1-half">
          ...
          <div class="view zoom">
            ...
            <div class="stripe light">
              <a>
                <p class="text-uppercase font-weight-bold">diy tattoos
                  <i class="fas fa-angle-right"></i>
                </p>
              </a>
            </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        ...
        <div class="card collection-card z-depth-1-half">
          ...
          <div class="view zoom">
            ...
            <div class="stripe dark">
              <a>
                <p class="text-uppercase font-weight-bold">freehand
                  <i class="fas fa-angle-right"></i>
                </p>
              </a>
            </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        ...
        <div class="card collection-card z-depth-1-half">
          ...
          <div class="view zoom">
            ...
            <div class="stripe light">
              <a>
                <p class="text-uppercase font-weight-bold">customization
                  <i class="fas fa-angle-right"></i>
                </p>
              </a>
            </div>
    ...
    <div id="multi-item-example" class="carousel slide carousel-multi-item" data-ride="carousel">
      <div class="row">
         <div class="col-md-4 mt-3">
            <h3 class="font-weight-bold">Xpress Tattoos</h3>
         </div>
         <div class="col-md-4">
            <!-- Controls -->
...
<div class="container my-5">
   ...
   <section>
      <div class="row mb-3">
         <div class="col-md-6">
            <h3 class="font-weight-bold">DIY Tattoos</h3>
         </div>
...
<div class="container my-5">
   ...
   <section>
      <div class="row">
         <div class="col-md-6">
            <h3 class="font-weight-bold dark-grey-text mb-5">Freehand</h3>
         </div>
         <div class="col-md-6 text-right">
            <a href="" class="btn btn-outline-primary btn-md">View all</a>
         </div>
      ...
      <div class="row">
         ...
         <div class="card card-ecommerce">
            ...
            <div class="card-body">
               ...
               <div class="row mb-0">
                  ...
                  <span class="float-right">
                     <a data-toggle="tooltip" data-placement="top" title="Add to Cart"><i class="fas fa-shopping-cart ml-3"></i></a>
                  </span>
               </div>
               </div>
            </div>
         ...
         <div class="card card-ecommerce">
            ...
            <div class="card-body">
               ...
               <div class="card-footer pb-0">
               <div class="row mb-0">
                  <h5 class="mb-0 pb-0 mt-1 font-weight-bold"><span class="red-text"><strong>$1199</strong></span>
